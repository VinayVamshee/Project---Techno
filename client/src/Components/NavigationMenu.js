        ...
        <>
            ...
            <div className="modal fade" style={{ marginTop: '0px' }} id="CalendarModal" tabIndex="-1" aria-labelledby="CalendarModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-xl ">
                    <div className="modal-content text-light calendar">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="CalendarModalLabel">School-Calendar</h1>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
...
<iframe title='technoschool' src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=Asia%2FKolkata&showPrint=0&src=dGVjaG5vc2Nob29sYnNwQGdtYWlsLmNvbQ&src=Y2xhc3Nyb29tMTAzOTY4Nzk5NjQ4MTI2MDU2NTk5QGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23AD1457&color=%23AD1457"></iframe>
                        </div>
